 ...
 * @author HP
 */
public class UpdateMainAdminDetails extends javax.swing.JFrame {

    /**
     * Creates new form UpdateMainAdminDetails
     */
    public UpdateMainAdminDetails() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField1.setText("UPDATE MY PROFILE");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        // TODO add your handling code here:
        try{
            DBUtil.DatabaseConnection.iud("update mainadmin set username = '"+Mname.getText()+"',password='"+Mpassword.getText()+"' where id='"+Mid.getText()+"'");
            JOptionPane.showMessageDialog(null, "update your profile successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateMainAdminDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateMainAdminDetails().setVisible(true);
            }
        });
    }
